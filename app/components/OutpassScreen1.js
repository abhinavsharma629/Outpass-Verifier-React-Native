...
class OutpassScreen1 extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <ScrollView>
        <TextInput
          ...
          value={this.state.outpassData.student_fullName}
        />
        <Text />
        <Header
          leftComponent={{ icon: "assignment", color: "#fff", top: -10 }}
          centerComponent={{
            text: "Outpass Details",
        ...
        <Input
          ...
          value={String(this.state.outpassData.days)}
          style={{ left: 20 }}
        />
        ...
        <Input
          ...
          value={this.state.outpassData.from}
        />
        ...
        <Input
          ...
          value={this.state.outpassData.to}
        />
        <Text />
        <TextInput
          multiline={true}
